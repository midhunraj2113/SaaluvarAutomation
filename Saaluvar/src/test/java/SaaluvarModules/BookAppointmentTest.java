...
public class BookAppointmentTest extends BaseLoginTest {
    ...
    public void mobileFieldTests() throws InterruptedException {
		...
		// TC5: Verify that field does not accept spaces
		mobileField.clear();
		mobileField.sendKeys("789 456 1233");
		System.out.println("TC5 - No spaces accepted: " +
		    (!mobileField.getAttribute("value").contains(" ") ? "PASS" : "FAIL"));
		
		// TC6: Verify correct mobile number is processed
		mobileField.clear();
		mobileField.sendKeys("7894561233");
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//option[text()='check 1']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//select[@name='man'])[2]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//option[text()='Consultation']")).click();
		...
		driver.findElement(By.xpath("//input[@placeholder='Enter Referral Source'] ")).sendKeys("Friend");
		driver.findElement(By.xpath("//input[@placeholder='Enter Visit Reason']  ")).sendKeys("doctor");
		Thread.sleep(2000);
		try {
		    ...
		    System.out.println("TC6 - Valid Name : PASS");

		} catch (Exception e) {
		    System.out.println("TC6 - Invalid Name : FAIL");
		}
	...
	// TC1: Check that the Name field is empty
		...
		try {
		    ...
		    System.out.println("TC6 - Valid Mobile number: PASS");

		} catch (Exception e) {
		    System.out.println("TC6 - Invalid Mobile Number: FAIL");
		}
    ...
    System.out.println("================== Appointment==================");
        ...
        System.out.println("TC3 - List displayed: FAIL");
    		...
    		WebElement dropdown1 = driver.findElement(By.id("appointment"));
    		Select select = new Select(dropdown1);

    		String selectedText = select.getFirstSelectedOption().getText();

    		if (selectedText.equals("New Appointment")) {
    			System.out.println("TC4 - Appointment Type selected: PASS");
    		} else {
    			System.out.println("TC4 - Appointment Type not selected: FAIL");
    }
    		driver.navigate().refresh();
    		driver.findElement(By.className("homeheader-book-text")).click();
    		driver.findElement(By.xpath("//input[@placeholder='Enter Mobile Number']")).sendKeys("7894561233");
    ...
    Thread.sleep(2000);
 			...
 			driver.findElement(By.xpath("//option[text()='Durai JP']")).click();
    ...
    Thread.sleep(2000);
 			...
 			driver.findElement(By.xpath("(//option[text()='Consultation'])[1]")).click();
    ...
    Thread.sleep(2000);
    	...
    	@Test(priority = 9)
 		...
 		// TC4: Error message if numeric/special values entered
	        ...
	        driver.findElement(By.xpath("//option[text()='New Appointment']")).click();
	        Thread.sleep(2000);
	        driver.findElement(By.className("//button[text()='DD/MM/YYYY']")).click();
	        Thread.sleep(2000);
	        driver.findElement(By.xpath("//button[@class='react-datepicker__navigation react-datepicker__navigation--next']")).click();
	        driver.findElement(By.xpath("//div[text()='24']")).click();
	        Thread.sleep(2000);
			...
			if (msg.contains("success") || msg.contains("Success")) {
			    System.out.println("TC4 - Crrt Mobile Number: PASS");
			} else {
			    System.out.println("TC4  - Crrt Mobile Number: FAIL");
			}
